...
if($flag==0)
$query1 = "SELECT DISTINCT * FROM $branchn, $branchm where $branchn.ENROLLMENTNO=$branchm.ENROLLMENTNO AND $branchm.ENROLLMENTNO LIKE '___$college1%'  ORDER BY PERCENTAGEC DESC";
else
	$query1 = "SELECT DISTINCT * FROM $branchn, $branchm where $branchn.ENROLLMENTNO=$branchm.ENROLLMENTNO AND ($branchm.ENROLLMENTNO LIKE '___$college1%' OR $branchm.ENROLLMENTNO LIKE '___$college2%' ) ORDER BY PERCENTAGEC DESC";
