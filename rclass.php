...
<form action="rclasscredit.php" method='POST'>
...
if($flag==0)
{$query1 = "SELECT DISTINCT * FROM $branchn, $branchm where $branchn.ENROLLMENTNO=$branchm.ENROLLMENTNO AND $branchm.ENROLLMENTNO LIKE '___$college1%'  ORDER BY PERCENTAGEWC DESC";
}

else
{$query1 = "SELECT DISTINCT * FROM $branchn, $branchm where $branchn.ENROLLMENTNO=$branchm.ENROLLMENTNO AND ($branchm.ENROLLMENTNO LIKE '___$college1%' OR $branchm.ENROLLMENTNO LIKE '___$college2%' ) ORDER BY PERCENTAGEWC DESC";
}
