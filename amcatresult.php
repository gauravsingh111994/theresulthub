...
<h3 style="font-size:20px;margin-top:-30px;">(Based on total Marks)</h3>
...
<form action="amcatresultperc.php" method='POST'>
<input type='submit' value='Click here for ranklist based on avg percentile'></input></form>
<br><br>
...
$branch=isset($_GET['branch'])?$_GET['branch']:$_SESSION['branch'];
...
$query="SELECT *from marks where branch='$branch' ORDER BY tmarks DESC";
