...
<body>
  ...
  <form action='moborclass.php' method='POST'>
   <h2><u>RANKLIST</u></h2>
	
	  <input type='text' placeholder='Enter your college code' name='college'>
   <input type='text'  placeholder='Branch Code' name='branch'>
     <br><br>
   <a href= "help.php" ><span style="color:white;margin-left: 10%;">Click here for help with branch code and college code.</span></a>
