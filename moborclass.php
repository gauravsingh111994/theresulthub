...
<form action="moborclasscredit.php" method='POST'>
...
if($flag==0)
$query1 = "SELECT DISTINCT * FROM $branch1 where $branch1.ENROLLMENTNO LIKE '___$college1%'  ORDER BY PERCENTAGEWC DESC";
else
	$query1 = "SELECT DISTINCT * FROM $branch1 where ($branch1.ENROLLMENTNO LIKE '___$college1%' OR $branch1.ENROLLMENTNO LIKE '___$college2%')   ORDER BY PERCENTAGEWC DESC";
$count=1;
