...
if(screen.width<800 )
	window.location="moboverallr2.php";
	</script>
...
<body>
  ...
  <form action='orclass.php' method='POST'>
   <h2><u>RANKLIST</u></h2>
	 
	 
	 
	 <input type='text' placeholder='Enter your college code' name='college'>
   <input type='text'  placeholder='Branch Code' name='branch'>
     <br><br>
   <a href= "help.php" ><span style="color:white;margin-left: 50px;">Click here for help with branch code and college code.</span></a>
